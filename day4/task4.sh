...
sudo tar xzf jdk-13.0.2_linux-x64_bin.tar.gz -C /opt
...
sudo tar -xzf mongodb-linux-x86_64-rhel70-4.2.2.tgz -C /opt

sudo cp /opt/mongodb-linux-x86_64-rhel70-4.2.2/bin/* /usr/local/bin/
